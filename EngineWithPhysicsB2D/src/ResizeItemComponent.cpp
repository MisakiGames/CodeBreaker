...
void ResizeItemComponent::update(float deltaTime)
{
    ...
    {
        const float playerColliderPositionMultiplier = 1.5f;
        ...
        bool     density     = fixture->GetDensity();
        ...
        shape.SetAsBox(size.x / 2, size.y / 2, b2Vec2{size.x / 2, size.y * playerColliderPositionMultiplier}, 0);
        ...
        bool     dashDensity     = dashFixture->GetDensity();
        ...
        dashFixtureDef.density     = dashDensity;
